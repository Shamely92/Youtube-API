...
with col1:
    ...
    Get_data = st.button('Upload to MongoDB')
    ...
    if Get_data or st.session_state.get("Get_state",False):
        ...
        api_version = 'v3'
        api_key = 'AIzaSyA9CfTWyCQL9GzW_N_FvuMHtR5Rp5_Lsnk'
        ...
        # function to retrieve video IDs from channel playlist
        ...
        # Function call to Get  video_ids 
        ...
        collection = mydb['Youtube_Channel']

        final_output_data = {'Channel_Name': channel_name,"Channel_data":final_output}
...
with col2:
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        engine = create_engine('mysql+pymysql://root:Surya#1234@localhost/youtube_project', echo=False)
...
if question_tosql:
    connect_for_question = pymysql.connect(host='127.0.0.1', user='root', password='Surya#1234', db='youtube_project')
